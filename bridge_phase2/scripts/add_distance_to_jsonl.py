...
def estimate_distance_on_road(K, img_w, img_h, cam_height_m=1.4, pitch_deg=0, v_frac=0.72):
    """
...
def main():
    ...
    ap.add_argument("--cam_height", type=float, default=1.05, help="Camera height above road in meters")
    ap.add_argument("--pitch_deg", type=float, default=0.0, help="Downward pitch estimate in degrees")
    ap.add_argument("--v_frac", type=float, default=0.72, help="Road pixel vertical fraction (0.0 top -> 1.0 bottom)")
